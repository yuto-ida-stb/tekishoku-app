      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg text-xs md:text-sm font-medium transition-all duration-200 cursor-pointer shadow-sm border active:scale-95 ${
                            isActive
                              ...
                              : "bg-white border-gray-200 text-gray-600 hover:bg-orange-50 hover:border-orange-300 hover:text-orange-700"
                          }`}
                        >
                          {name}
                        </button>
        ...
        <div className="max-w-md mx-auto space-y-4 pb-6">
          <button
            ...
            className="w-full bg-white border border-orange-300 text-orange-700 font-bold py-3 px-6 rounded-xl shadow-sm hover:bg-orange-50 transition-all duration-200 text-sm md:text-base"
          >
            診断結果へ戻る
          </button>
